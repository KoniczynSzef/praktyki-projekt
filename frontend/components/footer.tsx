    ...
    <footer className="bg-gray-100 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              LearnHub is dedicated to providing high-quality online education to learners worldwide.
            </p>
          </div>
          <div>
          ...
          <div>
            <h3 className="mb-4 text-lg font-semibold text-gray-800 dark:text-gray-200">Follow Us</h3>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">&copy; 2023 LearnHub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
